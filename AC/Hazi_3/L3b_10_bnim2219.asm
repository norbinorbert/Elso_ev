...
;L3b_10
;Keszítsünk assembly programot, amely beolvas három előjel nélküli egész számot 32 bites egészként, 
;kiírja a felhasznált szabályt, mint üzenetet, és a beolvasott értékeket, mint 32 bites bináris egészeket, 
;külön soronként, majd előállítja és végül kiírja bináris formában a művelet eredményét, 
;ami szintén egy 32 bites egész szám. Az eredményt nem szabad több részletben kiiírni, 
;az egyetlen érték kell legyen, amit elő kell állítani kiírás előtt! A három értéket A, B, C sorrendben olvassuk be.
